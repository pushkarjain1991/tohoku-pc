...
#------------------------------
    ...
    if clawdata.output_style == 1:
        ...
        #clawdata.output_times = numpy.arange(1836.0, 57601.0, 900.0)
        #clawdata.output_times = numpy.arange(0.0, 7345.0, 144.0)
    ...
    rundata.gaugedata.gauges.append([51407, 203.484, 19.642, 0., 1.e10])
    #rundata.gaugedata.gauges.append([52402, 154.116, 11.883, 10000., 1.e10])
    rundata.gaugedata.gauges.append([52402, 154.116, 11.883, 0., 1.e10])
